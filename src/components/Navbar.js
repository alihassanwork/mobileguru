...
//           <ImageAsset className="w-20 ml-5 h-20 mr-auto  " src="websiteLogo" />
//           <ImageAsset
//             onClick={() => toggleDrawer(!open)}
//             className="w-8 h-8 mr-5 mt-5 ml-auto inline lg:block "
//             src="menuIcon"
//           />
//         </div>

//         <div className=" hidden lg:block flex-col w-full mt-10 lg:mt-20 ml-2 lg:ml-3">
...
//         {open && (
//           <div className="flex flex-col w-full mt-10 lg:mt-20 ml-2 lg:ml-3 ease-in-out">
//             <div className="mainnavContent   w-full lg:w-7/12 ">
//               <nav className="pl-10 pr-10  lg:pl-0 lg:pr-0">
//                 <ul className="flex flex-col lg:flex-row justify-between text-sm  space-y-3 items-baseline cursor-pointer">
//                   <li>
