  ...
  return (
    <div className="w-full">
      <div className="card rounded-tl-[3rem]  mt-5 pb-4  rounded-b-[3rem]  bg-backgroundGreenColor w-full">
        ...
        <div>
          <div className=" flex flex-parent gap-x-[1rem] pl-2 pr-1 mt-5">
            {products.slice(0, 3).map(({ name, src }) => {
              return (
                <div className="flex-item">
                  <div className="flex flex-col w-full text-xs text-white">
                    <ImageAsset className="w-full h-[5rem] " src={src} />
                    <h3>{name}</h3>
                  </div>
                </div>
              );
          ...
          <div className="w-full text-center mt-4 text-lg text-white ">
            <button className="bg-buttonBgColor bg-gradient-to-b text-sm p-2 pl-4 pr-4 rounded-md from-buttonBgColorGradian1 to-buttonBgcolorGradian2">
              Explore More
            </button>
          </div>
        </div>
