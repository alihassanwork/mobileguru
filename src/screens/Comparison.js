...
import { getAllPhonesForComparison, getComparisonMobileById, getComparisonMobileById1, getComparisonMobileById2 } from "../redux/actions/mobileActions";
import { baseURL } from "api/baseURL";
const Comparison = () => {
  const { allMobilesForComparison, firstComparisonMobile, secondComparisonMobile } = useSelector((state) => state.comparisonReducer);
  ...
  const averageReview = !myCheck ? total / firstComparisonMobile.reviews.length : 0;
  ...
  const total2 = !myCheck2
    ...
    : 1;
  console.log("total sum===>", total);
  const averageReview2 = !myCheck2 ? total2 / secondComparisonMobile.reviews.length : 0;
  return (
    <React.Fragment>
      <Navbar />
      {console.log(allMobilesForComparison, "this is all mobiles in component")}
      {console.log("first comparison mobiles data", firstComparisonMobile)}
      {console.log("second comparison mobiles data", secondComparisonMobile)}
          ...
          <div className="flex flex-col lg:flex-row bg-[#D2DCE7] ">
            ...
            <div className=" w-full lg:w-1/2 z-50 flex-col  ">
              <div className="flex-col relative z-50 w-full bg-white pb-5">
                ...
                <input value={searchBar1} onChange={(e) => setSearchBar1(e.target.value)}
                ...
                <div className={`absolute bg-gray-100 lg:w-[70%] md:w-[90%] rounded-md py-2 px-4 z-50 mx-auto ${!searchBar1 ? 'hidden' : ''}`}>
                  {allMobilesForComparison.filter((val) => {
                    if (searchBar1 === "") {
                      return val
                    }
                    else if (val.mobile.toLowerCase().includes(searchBar1.toLowerCase())) {
                      return val
                    }
                  }).map((data, index) => {
                    return (
                      <div className={`z-50 cursor-pointer`}>{searchBar1 ? <div onClick={() => {
              ...
              {myCheck ?
                ...
                :
                <div>
                  <div className={`w-full lg:w-[70%] z-0 text-xs pb-3 font-medium mt-[0.4rem]
               ...
               border-2 rounded-md border-black`}>
                    <img
                      ...
                      src={!myCheck ? `${baseURL}${firstComparisonMobile.mobilePhotos[0]}` : ''}
                    />
                    <h3>{!myCheck ? firstComparisonMobile.brandName + " / " + firstComparisonMobile.modelNumber : ''} </h3>
                    <h3>{!myCheck ? firstComparisonMobile.priceInPKR + " RS" : ''}</h3>
                    ...
                    <div className="flex-col lg:flex lg:flex-row w-full mt-5 border-black border-b-2 pb-3">
                      ...
                      <div className="flex-col w-full">
                        ...
                        <div className=" flex w-full  border-black border-b-[0.03rem]">
                          ...
                          <label htmlFor="" className="text-sm font-medium w-[67%]">
                            {!myCheck ? `${firstComparisonMobile.build.UI}` : ""}
                          </label>
                        </div>
                        <div className=" flex w-full  border-black border-b-[0.03rem]">
                          <h3 className="w-1/3 text-sm font-bold">DIMENSIONS</h3>
                          <label htmlFor="" className="text-sm font-medium w-[67%]">
                            {!myCheck ? `${firstComparisonMobile.build.dimensions}` : ""}
                          </label>
                        </div>
                        <div className=" flex w-full  border-black border-b-[0.03rem]">
                          <h3 className="w-1/3 text-sm font-bold">WEIGHT</h3>
                          <label htmlFor="" className="text-sm font-medium w-[67%]">
                            {!myCheck ? `${firstComparisonMobile.build.weight} Grams` : ""}
                          </label>
                        </div>
                        <div className=" flex w-full  border-black border-b-[0.03rem]">
                          <h3 className="w-1/3 text-sm font-bold">SIM</h3>
                          <label htmlFor="" className="text-sm font-medium w-[67%]">
                            {!myCheck ? `${firstComparisonMobile.build.sim}` : ""}
                          </label>
                        </div>
                        <div className=" flex w-full ">
                          <h3 className="w-1/3 text-sm font-bold">COLORS</h3>
                          <label htmlFor="" className="text-sm font-medium w-[67%]">
                            {!myCheck ? `${firstComparisonMobile.build.colors}` : ""}
                          </label>
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="flex-col lg:flex lg:flex-row w-full mt-5 border-black border-b-2 pb-3">
                      ...
                      <div className="flex-col w-full">
                        <div className="flex w-full border-black border-b-[0.03rem] ">
                          ...
                          <label htmlFor="" className="text-sm font-medium w-[67%]">
                            {!myCheck ? `${firstComparisonMobile.processor.CPU}` : ""}
                          </label>
                          <br />
                        </div>
                        <div className=" flex w-full border-black border-b-[0.03rem]">
                          ...
                          >
                            {!myCheck ? `${firstComparisonMobile.processor.chipSet}` : ""}
                          </label>
                        </div>
                        <div className=" flex w-full border-black border-b-[0.03rem]">
                          <h3 className="w-1/3 text-sm font-bold">GPU</h3>
                          <label htmlFor="" className="text-sm font-medium w-[67%]">
                            {myCheck ? `${firstComparisonMobile.processor.GPU}` : ""}
                          </label>
                        </div>
                      </div>
                    </div>
                    <div className=" flex-col lg:flex lg:flex-row w-full mt-5 border-black border-b-2 pb-3">
                      ...
                      <div className="flex-col w-full">
                        <div className="flex w-full border-black border-b-[0.03rem]">
                          ...
                          <label htmlFor="" className="text-sm font-medium w-[67%]">
                            {!myCheck ? `${firstComparisonMobile.display.technology}` : ""}
                          </label>{" "}
                          <br />
                        </div>
                        <div className=" flex w-full  border-black border-b-[0.03rem]">
                          ...
                          <label htmlFor="" className="text-sm font-medium w-[67%]">
                            {!myCheck ? `${firstComparisonMobile.display.size}` : ""}
                          </label>
                        </div>
                        <div className=" flex  w-full  border-black border-b-[0.03rem]">
                          <h3 className="w-1/3 text-sm font-bold">Resolution</h3>
                          <label htmlFor="" className="text-sm font-medium w-[67%] ">
                            {!myCheck ? `${firstComparisonMobile.display.resolution}` : ""}
                          </label>
                        </div>
                        ...
                        <div className=" flex w-full ">
                          ...
                          <label htmlFor="" className="text-sm font-medium w-[67%]">
                            {!myCheck ? `${firstComparisonMobile.display.extraFeatures}` : ""}
                          </label>
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="flex-col lg:flex lg:flex-row w-full mt-5 border-black border-b-2 pb-3">
                      ...
                      <div className="flex-col w-full">
                        ...
                        <div className=" flex w-full border-black border-b-[0.03rem]">
                          ...
                          <label htmlFor="" className="text-sm font-medium w-[67%]">
                            {!myCheck ? `${firstComparisonMobile.memory.card} GB` : ""}
                          </label>
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="flex-col lg:flex lg:flex-row w-full mt-5 border-black border-b-2 pb-3">
                      ...
                      <div className="flex-col w-full">
                        ...
                        <div className=" flex w-full border-black border-b-[0.03rem]">
                          ...
                          <label htmlFor="" className="text-sm font-medium w-[67%]">
                            {!myCheck ? `${firstComparisonMobile.camera.features}` : ""}
                          </label>
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="flex-col lg:flex lg:flex-row w-full mt-5 border-black border-b-2 pb-3">
                      ...
                      <div className="flex-col w-full">
                        <div className="flex w-full border-black border-b-[0.03rem] ">
                          ...
                          <label htmlFor="" className="text-sm font-medium w-[67%]">
                            {!myCheck ? `${firstComparisonMobile.features.sensor}` : ""}
                          </label>
                          <br />
                        </div>
                        <div className=" flex w-full border-black border-b-[0.03rem]">
                          ...
                          <label
                            ...
                            className="text-sm font-medium lg:ml-0 w-[67%]"
                          >
                            {!myCheck ? `${firstComparisonMobile.features.audio}` : ""}
                          </label>
                        </div>
                        <div className=" flex w-full border-black border-b-[0.03rem]">
                          <h3 className="w-1/3 text-sm font-bold">Browser</h3>
                          <label htmlFor="" className="text-sm font-medium w-[67%]">
                            {!myCheck ? `${firstComparisonMobile.features.browser}` : ""}
                          </label>
                        </div>
                        <div className=" flex w-full border-black border-b-[0.03rem]">
                          <h3 className="w-1/3 text-sm font-bold">Messaging</h3>
                          <label htmlFor="" className="text-sm font-medium w-[67%]">
                            {!myCheck ? `${firstComparisonMobile.features.messaging}` : ""}
                          </label>
                        </div>
                        <div className=" flex w-full border-black border-b-[0.03rem]">
                          <h3 className="w-1/3 text-sm font-bold">Games</h3>
                          <label htmlFor="" className="text-sm font-medium w-[67%]">
                            {!myCheck ? `${firstComparisonMobile.features.games}` : ""}
                          </label>
                        </div>
                        <div className=" flex w-full border-black border-b-[0.03rem]">
                          <h3 className="w-1/3 text-sm font-bold">Torch</h3>
                          <label htmlFor="" className="text-sm font-medium w-[67%]">
                            {!myCheck ? `${firstComparisonMobile.features.torch}` : ""}
                          </label>
                        </div>
                        <div className=" flex w-full border-black border-b-[0.03rem]">
                    ...
                    <div className="flex-col lg:flex lg:flex-row w-full mt-5 border-black border-b-2 pb-3">
                      ...
                      <div className="flex-col w-full">
                        <div className="flex w-full border-black border-b-[0.03rem] ">
                          ...
                          <label htmlFor="" className="text-sm font-medium w-[67%]">
                            {!myCheck ? `${firstComparisonMobile.battery.capacity} mAh` : ""}
                          </label>
                          <br />
                        </div>
                        <div className=" flex w-full border-black border-b-[0.03rem]">
                          ...
                          <label
                            ...
                            className="text-sm font-medium lg:ml-0 w-[67%]"
                          >
                            {!myCheck ? `${firstComparisonMobile.battery.description}` : ""}
                          </label>
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="flex-col lg:flex lg:flex-row w-full mt-5 border-black border-b-2 pb-3">
                      ...
                      <div className="flex-col w-full">
                        <div className="flex w-full border-black border-b-[0.03rem] ">
                          ...
                          <label htmlFor="" className="text-sm font-medium w-[67%]">
                            {!myCheck ? `Price in Rs: ${firstComparisonMobile.priceInPKR}` : ""}
                          </label>
                          <br />
                        </div>
                        <div className=" flex w-full border-black border-b-[0.03rem]">
                          ...
                          <label
                            ...
                            className="text-sm font-medium lg:ml-0 w-[67%]"
                          >
                            {!myCheck ? ` Price in USD: $${firstComparisonMobile.priceInUSD}` : ""}{" "}
                          </label>
                        </div>
                      </div>
                    </div>
                        ...
                        <div className=" flex w-full">
                          {averageReview ? (
                            ...
                            >
                              ...
                              - based on{" "}
                              <strong>
                                {!myCheck ? firstComparisonMobile.reviews.length : 0}{" "}
                              </strong>
                              user reviews.
                            </label>
                          ) : (
            ...
            <div className="w-full lg:w-1/2 flex-col  ">
              <div className="flex-col w-full bg-white pb-5">
                <h3 className="text-sm font-medium">Compare With</h3>
                <input value={searchBar2} placeholder="Seacrh second mobile here"
                ...
                <div className={`absolute bg-gray-100 lg:w-[31%] md:w-[87%] rounded-md cursor-pointer py-2 px-4 z-50 mx-auto ${!searchBar2 ? 'hidden' : ''}`}>
                  {allMobilesForComparison.filter((val) => {
                    if (searchBar2 === "") {
                      return val
                    }
                    else if (val.mobile.toLowerCase().includes(searchBar2.toLowerCase())) {
                      return val
                    }
                  }).map((data, index) => (
                    <div className="z-50">{searchBar2 ? <div onClick={() => {
              ...
              {myCheck2 ?
               ...
               border-2 rounded-md border-black`}>
                    <img
                      className=" object-top p-2  object-contain h-[20rem]"
                      src={!myCheck2 ? `${baseURL}${secondComparisonMobile.mobilePhotos[0]}` : ''}
                    />
                    <h3>{!myCheck2 ? secondComparisonMobile.brandName + " / " + secondComparisonMobile.modelNumber : ''} </h3>
                    <h3>{!myCheck2 ? secondComparisonMobile.priceInPKR + " RS" : ''}</h3>
                    <div className="flex w-full  justify-center">

                    </div>
                    <h3>{!myCheck2 ? secondComparisonMobile.releaseDate : ''}</h3>
                  </div>
                    ...
                    <div className="flex-col lg:flex lg:flex-row w-full mt-5 border-black border-b-2 pb-3">
                      ...
                      <div className="flex-col w-full">
                        ...
                        <div className=" flex w-full  border-black border-b-[0.03rem]">
                          <h3 className="w-1/3 text-sm font-bold">UI</h3>
                          <label htmlFor="" className="text-sm font-medium w-[67%]">
                            {!myCheck2 ? `${secondComparisonMobile.build.UI}` : ""}
                          </label>
                        </div>
                        <div className=" flex w-full  border-black border-b-[0.03rem]">
                          <h3 className="w-1/3 text-sm font-bold">DIMENSIONS</h3>
                          <label htmlFor="" className="text-sm font-medium w-[67%]">
                            {!myCheck2 ? `${secondComparisonMobile.build.dimensions}` : ""}
                          </label>
                        </div>
                        <div className=" flex w-full  border-black border-b-[0.03rem]">
                          <h3 className="w-1/3 text-sm font-bold">WEIGHT</h3>
                          <label htmlFor="" className="text-sm font-medium w-[67%]">
                            {!myCheck2 ? `${secondComparisonMobile.build.weight} Grams` : ""}
                          </label>
                        </div>
                        <div className=" flex w-full  border-black border-b-[0.03rem]">
                          <h3 className="w-1/3 text-sm font-bold">SIM</h3>
                          <label htmlFor="" className="text-sm font-medium w-[67%]">
                            {!myCheck2 ? `${secondComparisonMobile.build.sim}` : ""}
                          </label>
                        </div>
                        <div className=" flex w-full ">
                          <h3 className="w-1/3 text-sm font-bold">COLORS</h3>
                          <label htmlFor="" className="text-sm font-medium w-[67%]">
                            {!myCheck2 ? `${secondComparisonMobile.build.colors}` : ""}
                          </label>
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="flex-col lg:flex lg:flex-row w-full mt-5 border-black border-b-2 pb-3">
                      ...
                      <div className="flex-col w-full">
                        <div className="flex w-full border-black border-b-[0.03rem] ">
                          <h3 className="w-1/3 text-sm font-bold">CPU</h3>
                          <label htmlFor="" className="text-sm font-medium w-[67%]">
                            {!myCheck2 ? `${secondComparisonMobile.processor.CPU}` : ""}
                          </label>
                          <br />
                        </div>
                        <div className=" flex w-full border-black border-b-[0.03rem]">
                          ...
                          <label
                            ...
                            className="text-sm font-medium  lg:ml-0 w-[67%]"
                          >
                            {!myCheck2 ? `${secondComparisonMobile.processor.chipSet}` : ""}
                          </label>
                        </div>
                        <div className=" flex w-full border-black border-b-[0.03rem]">
                          <h3 className="w-1/3 text-sm font-bold">GPU</h3>
                          <label htmlFor="" className="text-sm font-medium w-[67%]">
                            {myCheck ? `${secondComparisonMobile.processor.GPU}` : ""}
                          </label>
                        </div>
                      </div>
                    </div>
                    <div className=" flex-col lg:flex lg:flex-row w-full mt-5 border-black border-b-2 pb-3">
                      ...
                      <div className="flex-col w-full">
                        <div className="flex w-full border-black border-b-[0.03rem]">
                          <h3 className="w-1/3 text-sm font-bold">Technology</h3>
                          <label htmlFor="" className="text-sm font-medium w-[67%]">
                            {!myCheck2 ? `${secondComparisonMobile.display.technology}` : ""}
                          </label>{" "}
                          <br />
                        </div>
                        <div className=" flex w-full  border-black border-b-[0.03rem]">
                          <h3 className="w-1/3 text-sm font-bold">Size</h3>
                          <label htmlFor="" className="text-sm font-medium w-[67%]">
                            {!myCheck2 ? `${secondComparisonMobile.display.size}` : ""}
                          </label>
                        </div>
                        <div className=" flex  w-full  border-black border-b-[0.03rem]">
                          <h3 className="w-1/3 text-sm font-bold">Resolution</h3>
                          <label htmlFor="" className="text-sm font-medium w-[67%] ">
                            {!myCheck2 ? `${secondComparisonMobile.display.resolution}` : ""}
                          </label>
                        </div>
                        ...
                        <div className=" flex w-full ">
                          <h3 className="w-1/3 text-sm font-bold">Extra Features</h3>
                          <label htmlFor="" className="text-sm font-medium w-[67%]">
                            {!myCheck2 ? `${secondComparisonMobile.display.extraFeatures}` : ""}
                          </label>
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="flex-col lg:flex lg:flex-row w-full mt-5 border-black border-b-2 pb-3">
                      ...
                      <div className="flex-col w-full">
                        ...
                        <div className=" flex w-full border-black border-b-[0.03rem]">
                          <h3 className="w-1/3 text-sm font-bold">Card</h3>
                          <label htmlFor="" className="text-sm font-medium w-[67%]">
                            {!myCheck2 ? `${secondComparisonMobile.memory.card} GB` : ""}
                          </label>
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="flex-col lg:flex lg:flex-row w-full mt-5 border-black border-b-2 pb-3">
                      ...
                      <div className="flex-col w-full">
                        ...
                        <div className=" flex w-full border-black border-b-[0.03rem]">
                          <h3 className="w-1/3 text-sm font-bold">Features</h3>
                          <label htmlFor="" className="text-sm font-medium w-[67%]">
                            {!myCheck2 ? `${secondComparisonMobile.camera.features}` : ""}
                          </label>
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="flex-col lg:flex lg:flex-row w-full mt-5 border-black border-b-2 pb-3">
                      ...
                      <div className="flex-col w-full">
                        <div className="flex w-full border-black border-b-[0.03rem] ">
                          <h3 className="w-1/3 text-sm font-bold">Sensors</h3>
                          <label htmlFor="" className="text-sm font-medium w-[67%]">
                            {!myCheck2 ? `${secondComparisonMobile.features.sensor}` : ""}
                          </label>
                          <br />
                        </div>
                        <div className=" flex w-full border-black border-b-[0.03rem]">
                          ...
                          <label
                            ...
                            className="text-sm font-medium lg:ml-0 w-[67%]"
                          >
                            {!myCheck2 ? `${secondComparisonMobile.features.audio}` : ""}
                          </label>
                        </div>
                        <div className=" flex w-full border-black border-b-[0.03rem]">
                          <h3 className="w-1/3 text-sm font-bold">Browser</h3>
                          <label htmlFor="" className="text-sm font-medium w-[67%]">
                            {!myCheck2 ? `${secondComparisonMobile.features.browser}` : ""}
                          </label>
                        </div>
                        <div className=" flex w-full border-black border-b-[0.03rem]">
                          <h3 className="w-1/3 text-sm font-bold">Messaging</h3>
                          <label htmlFor="" className="text-sm font-medium w-[67%]">
                            {!myCheck2 ? `${secondComparisonMobile.features.messaging}` : ""}
                          </label>
                        </div>
                        <div className=" flex w-full border-black border-b-[0.03rem]">
                          <h3 className="w-1/3 text-sm font-bold">Games</h3>
                          <label htmlFor="" className="text-sm font-medium w-[67%]">
                            {!myCheck2 ? `${secondComparisonMobile.features.games}` : ""}
                          </label>
                        </div>
                        <div className=" flex w-full border-black border-b-[0.03rem]">
                          <h3 className="w-1/3 text-sm font-bold">Torch</h3>
                          <label htmlFor="" className="text-sm font-medium w-[67%]">
                            {!myCheck2 ? `${secondComparisonMobile.features.torch}` : ""}
                          </label>
                        </div>
                        <div className=" flex w-full border-black border-b-[0.03rem]">
                          <h3 className="w-1/3 text-sm font-bold">Extra</h3>
                    ...
                    <div className="flex-col lg:flex lg:flex-row w-full mt-5 border-black border-b-2 pb-3">
                      ...
                      <div className="flex-col w-full">
                        <div className="flex w-full border-black border-b-[0.03rem] ">
                          <h3 className="w-1/3 text-sm font-bold">Capacity</h3>
                          <label htmlFor="" className="text-sm font-medium w-[67%]">
                            {!myCheck2 ? `${secondComparisonMobile.battery.capacity} mAh` : ""}
                          </label>
                          <br />
                        </div>
                        <div className=" flex w-full border-black border-b-[0.03rem]">
                          ...
                          <label
                            ...
                            className="text-sm font-medium lg:ml-0 w-[67%]"
                          >
                            {!myCheck2 ? `${secondComparisonMobile.battery.description}` : ""}
                          </label>
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="flex-col lg:flex lg:flex-row w-full mt-5 border-black border-b-2 pb-3">
                      ...
                      <div className="flex-col w-full">
                        <div className="flex w-full border-black border-b-[0.03rem] ">
                          <h3 className="w-1/3 text-sm font-bold">Price in Rs</h3>
                          <label htmlFor="" className="text-sm font-medium w-[67%]">
                            {!myCheck2 ? `Price in Rs: ${secondComparisonMobile.priceInPKR}` : ""}
                          </label>
                          <br />
                        </div>
                        <div className=" flex w-full border-black border-b-[0.03rem]">
                          ...
                          <label
                            ...
                            className="text-sm font-medium lg:ml-0 w-[67%]"
                          >
                            {!myCheck2 ? ` Price in USD: $${secondComparisonMobile.priceInUSD}` : ""}{" "}
                          </label>
                        </div>
                      </div>
                    </div>
                        ...
                        <div className=" flex w-full">
                          {averageReview ? (
                            ...
                            >
                              ...
                              - based on{" "}
                              <strong>
                                {!myCheck2 ? secondComparisonMobile.reviews.length : 0}{" "}
                              </strong>
                              user reviews.
                            </label>
                          ) : (
